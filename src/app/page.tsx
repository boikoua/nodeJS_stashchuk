    ...
    <main className="flex items-center h-screen relative bg-cover bg-[url('/assets/bg-explosion.png')]">
      ...
      <div className="flex flex-col gap-3 z-[10] pl-40 pt-20">
        <h1 className="text-[50px] text-white max-w-[500px]">
          Transformer ideas into{' '}
          <span className="text-red-500">Digital Reality</span>
        </h1>

        <p className="text-[16px] text-gray-200 md:text-gray-400 mb-10 md:pb-2 max-w-[400px] mb-5">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Libero
          impedit maiores aspernatur natus ex! Sed excepturi reprehenderit nihil
          totam itaque ad quia, rem dolores unde. Dolorum aperiam atque modi a.
        </p>
